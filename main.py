...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_pa'
                        'th', default='C:/Research/2025/TSAD/dataset/pd/pd/', help='data-path')
    parser.add_argument('--save_path', default='C:/Research/2025/TSAD/Conferences/MIWAI/saved_models/pd/',
                        help='save-data-path')
    ...
    parser.add_argument('-lr', default=95e-4, type=float, help='learning rate ')
